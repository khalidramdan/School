        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('storeprof')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="adress" class="form-control" value="{{ old('adresse')}}" name="adresse">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">Date Inscription</label>
                                            <input class="datepicker-default form-control" value="{{ old('dateInscription')}}" id="datepicker" name="dateInscription">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">Tel</label>
                                            <input type="tel" class="form-control" value="{{ old('tel')}}" name="tel">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input class="datepicker-default form-control" value="{{ old('dateNaissance')}}" id="datepicker1" name="dateNaissance">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">Description</label>
                                            <textarea class="form-control" name="description" value="{{old('desc')}}" cols="30" rows="10" style="resize: none"></textarea>
                                        </div>
                                    </div>
