            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4>Document Profile</h4>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                        <li class="breadcrumb-item active"><a href="{{route('alldocument')}}">Documents</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">Document Profile</a></li>
                    </ol>
                </div>
            </div>
                                        ...
                                        <div id="about-me" class="tab-pane fade active show">
                                            ...
                                            <div class="profile-personal-info">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span>{{($document->tel)? $document->tel : ''}}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                </div>
